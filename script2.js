// а) Создание элементов

// 1) Создание элемента
// 2) Заполнение элемента
// 3) Вставка элемента

// ------------------------
// б) Измнение существующего элемента в разметке

// 1) Поиск элемента в разметке
...
function render(array){
    ...
    th_email.innerText = 'Email'

    tr_header.append(th_id,th_name, th_username, th_email)
    ...
    for (let elem of array){
        ...
        td_username.innerText = elem.username
        td_email.innerText = elem.email

        tr_elem.append(td_id,td_name, td_username, td_email)

    }
}


let div_root = document.querySelector('#kotiki')
